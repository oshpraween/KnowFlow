  ...
  return (
    <div className="container mx-auto px-4 py-16 max-w-6xl mb-8">
      ...
      <div className="flex justify-between items-center mb-8 mt-4">
        ...
        <button
          onClick={() => setShowCreateForm(true)}
          className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-6 py-3 rounded-full hover:shadow-lg transition-all duration-300 flex items-center gap-2 font-medium ml-4"
        >
      ...
      {loading ? (
        ...
        <div className="bg-white rounded-lg shadow-md p-8 text-center">
          ...
          <button
            onClick={() => setShowCreateForm(true)}
            className="bg-blue-500 hover:bg-blue-600 text-white font-medium py-3 px-6 rounded-full transition-all duration-200"
          >
                ...
                <div className="p-6">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {isOwner ? (
                      ...
                      <button
                        onClick={() => handleLeaveGroup(group.id)}
                        className="px-6 py-2.5 border border-gray-300 rounded-full text-gray-700 hover:bg-gray-100 transition-colors text-sm font-medium"
                      >
                        Leave
                      </button>
                    ) : (
                      <button
                        onClick={() => handleJoinGroup(group.id)}
                        className="px-6 py-2.5 bg-blue-500 text-white rounded-full hover:bg-blue-600 transition-colors text-sm font-medium flex items-center gap-1"
                      >
          ...
          <div className="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
            ...
            <form onSubmit={handleCreateGroup} className="p-6">
              ...
              <div className="flex justify-end gap-4">
                ...
                <button
                  type="submit"
                  className="px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg hover:shadow-md transition-all"
                >
                  Create Group
                </button>
              </div>
